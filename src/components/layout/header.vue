      ...
      <header class="header navbar navbar-expand-sm">
        <ul class="navbar-item theme-brand flex-row text-center">
          ...
          <li class="nav-item theme-text">
            <router-link to="/" class="nav-link"> QuantDAO</router-link>
          </li>
        </ul>
        ...
        <div class="navbar-item flex-row ml-md-auto">
          <div class="dark-mode d-flex align-items-center">
            <font color="white" size="2.5em" class="">
              &nbsp;&nbsp;GMT&nbsp;:&nbsp;{{ this.gmt.yr }}/{{
                this.gmt.month
              }}/{{ this.gmt.day }} {{ this.gmt.hour }}:{{ this.gmt.min }}:{{
                this.gmt.sec
              }}&nbsp;
            </font>
          ...
          >
            <template #button-content>
              <img
                src="@/assets/images/user-avtar.svg"
                alt="avatar"
              />&nbsp;&nbsp;<font color="white" size="2.5em">Ben Hao</font>
            </template>
...
<script>
import { LOGOUT } from "@/store/user.module";
export default {
  data() {
    return {
      selectedLang: null,
  ...
  mounted() {
    ...
    setInterval(() => {
      ...
      this.gmt.sec = now
        ...
        .toString()
        .padStart(2, "0");
      this.gmt.tick = Math.floor(now.getTime() / 1000) % 2 === 0;
      this.gmt.yr = now.getFullYear();
      this.gmt.month = now.getUTCMonth() + 1;
      this.gmt.day = now.getDate();
    }, 1000);
  },
  methods: {
    toggleMode(mode) {
